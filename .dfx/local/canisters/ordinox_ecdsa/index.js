...
import { idlFactory } from './ordinox_ecdsa.did.js';
export { idlFactory } from './ordinox_ecdsa.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ORDINOX_ECDSA;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ordinox_ecdsa.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ordinox_ecdsa canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ordinox_ecdsa.did.js")._SERVICE>}
 */
export const ordinox_ecdsa = createActor(canisterId);
